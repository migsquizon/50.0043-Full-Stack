...
reviews=sc.read.options(header=True).csv("hdfs:///anything/kindle_reviews.csv")
#reviews.show()
price = sc.read.json("hdfs:///anything/meta_Kindle_Store.json")
price.show()
#print(type(price))
...
reducer = flatdata.reduceByKey(lambda x,y:x+y)
print("reducer done")
#print(reducer[0])
out = reducer.take(5)
print(out)
