...
class MongoHandler(logging.Handler):
    ...
    def __init__(self, level=logging.NOTSET, host='18.140.90.36', port=27017,
                 database_name='Kindle', collection='logs',
                 username='Admin', password='yckcmkg', authentication_db='admin',
